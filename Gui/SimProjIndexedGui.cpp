...
#include "RankSimProjIndexed.hpp"
	...
	//
{
	...
	RankSimProjIndexed rankTrainingSet;

	bool autoRun = false;
	bool autoTerm = false;

	SimProjIndexedGui( int W, int H, const char *l = 0 )
		: DoubleWindow( W, H, l ),
...
int main( int argc, char *argv[] ) {
	...
	dlg = new SimProjIndexedGui( 1024, 768 );
	dlg->SetSettingName( argc > 1 ? argv[1] : "SimProjIndexedGui.cfg" );
	dlg->LoadSettings();
